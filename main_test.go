...
func TestDefault(t *testing.T) {
	configuration := &config{
		...
		images:             []string{"tobybellwood/haproxy:multiarch", "tobybellwood/dnsmasq:multiarch", "tobybellwood/mailhog:multiarch"},
...
func TestCustom(t *testing.T) {
	configuration := &config{
		...
		images:             []string{"tobybellwood/ssh-agent:multiarch", "amazeeio_mailhog", "phpmyadmin/phpmyadmin", "portainer/portainer", "library/traefik:v2.1.3"},
